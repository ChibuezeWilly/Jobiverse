...
const JobSeeker = () => {
	...
	const signedUser = { email, password, name };
		...
		<>
			<div className="flex flex-col mt-5 z-0">
				<div
					...
					<input type="checkbox" name="" id="" className="mt-5" value={""} />
					<label
						htmlFor="remember"
						className="ml-3 font-semibold text-base relative mt-5"
